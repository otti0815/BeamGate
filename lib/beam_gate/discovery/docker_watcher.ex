defmodule BeamGate.Discovery.DockerWatcher do
  @moduledoc """
  ...
  alias BeamGate.Discovery.{DockerClient, RuleParser}
  ...
  @impl true
  def init(_) do
    interval = Application.get_env(:beam_gate, :docker_poll_interval_ms, 5_000)
