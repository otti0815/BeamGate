defmodule BeamGate.Proxy.HealthChecker do
  ...
  @impl true
  def init(_) do
    interval = Application.get_env(:beam_gate, :health_check_interval_ms, 10_000)
  ...
  def handle_info(:check, state) do
    path = Application.get_env(:beam_gate, :health_check_path, "/health")
    ...
    |> Enum.each(fn endpoint ->
      ...
      status =
        case Finch.request(request, BeamGate.Finch, receive_timeout: 3_000) do
