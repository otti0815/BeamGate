defmodule BeamGateWeb.AdminSessionController do
  ...
  def create(conn, %{"username" => username, "password" => password}) do
    expected_user = Application.get_env(:beam_gate, :admin_user, "admin")
    expected_pass = Application.get_env(:beam_gate, :admin_pass, "admin")
