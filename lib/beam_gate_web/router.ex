defmodule BeamGateWeb.Router do
  use BeamGateWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {BeamGateWeb.Layouts, :root}
  end
  ...
  pipeline :admin_auth do
    plug BeamGateWeb.Plugs.AdminAuth
  end

  scope "/admin", BeamGateWeb do
  ...
  scope "/api/v1/search", BeamGateWeb do
    pipe_through :api
